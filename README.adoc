...
:url-repo: https://github.com/hyperpolymath/asdf-cfssl-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-cfssl-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-cfssl-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-cfssl-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Cfssl] versions.
...
Cfssl is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Cfssl versions per project

|**Project Isolation**
|Pin Cfssl per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Cfssl version
...
=== Installing Cfssl Versions

[source,bash]
----
asdf list all cfssl
asdf install cfssl latest
asdf install cfssl 0.1.0
----
...
[source,bash]
----
asdf global cfssl 0.1.0
asdf local cfssl 0.1.0
asdf current cfssl
cfssl --version
----
...
* Ensure `cfssl` is on PATH after installation.
* Verify the installed version with `cfssl --version`.
